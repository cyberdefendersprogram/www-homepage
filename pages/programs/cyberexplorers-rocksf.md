...
Cyber Explorers is a 15-week immersive program aimed at introducing Cyber Security discipline to high school and middle school students at [VVMS](https://www.sfusd.edu/school/visitacion-valley-middle-school) and [ROCKSF](https://rocksf.org/our-impact/). We call this cohort the *STAR CODERS*. The program doesn’t assume any exposure to computers and computer science. The first 3 sessions are tabletop fun games and exercises introducing concepts of Cyber Security like Cryptography, Network Security, Defense in Depth, Incident Detection, Incident Response et al.

The students will start early in the program on a team project which could be a cybersecurity-related puzzle, poster or a project. This is a deliverable which students are expected to showcase in the Cyber Explorers finale - a open source intelligence project and a python YOUR VOICE IS POWER submission.
...
<div class="container">
    <div class="columns is-multiline is-mobile is-centered">
        <div class="column is-half">
            ...
            <img src="{{site.url}}{{site.baseurl}}assets/images/rocksf.jpg"/>
            </figure>
        </div>
        <div class="column is-half">
...
<table class="table is-bordered is-striped">
    ...
    <tbody>
    {% for session in site.data.cyber-explorers-rocksf %} 
    <tr>
